...
const pages = ['riders', 'location', 'contest', 'photos'];
        ...
        <AppBar sx={{ backgroundColor: "gray" }} position="static">
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    <DirectionsBikeSharpIcon sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} />
                    <Typography
                        variant="h6"
                        noWrap
                        component="a"
                    ...
                    <DirectionsBikeSharpIcon sx={{ display: { xs: 'flex', md: 'none' }, mr: 1 }} />
                    <Typography
                        variant="h5"
                        noWrap
                        component="a"
